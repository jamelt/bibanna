...
test.describe('Dropdown Menus', () => {
  ...
  test('library entry detail page - dropdown menu opens and works', async ({ page }) => {
    ...
    await expect(page.getByRole('menuitem', { name: /copy citation/i })).toBeVisible({
      timeout: 5000,
    })
  ...
  test('project detail page - dropdown menu opens and works', async ({ page }) => {
    ...
    await expect(
      page.getByRole('heading', { name: 'Test Project for Dropdown Tests' }),
    ).toBeVisible()
  ...
  test('projects list page - dropdown menu opens and works', async ({ page }) => {
    ...
    const projectCard = page
      .locator('.group', { hasText: 'Test Project for Dropdown Tests' })
      .first()
  ...
  test('project detail page - add entry split button works', async ({ page }) => {
    ...
    await expect(
      page.getByRole('heading', { name: /quick add/i }).or(page.getByPlaceholder(/search/i)),
  ...
  test('project detail page - add entry split button dropdown works', async ({ page }) => {
    ...
    const modalVisible =
      (await page
        .getByRole('heading', { name: /add entries/i })
        .isVisible()
        .catch(() => false)) ||
      (await page
        .getByText(/select entries from your library/i)
        .isVisible()
        .catch(() => false))
