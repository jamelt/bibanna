...
<template>
  <div class="h-[calc(100vh-4rem)]">
    ...
    <div
      v-else-if="!hasFeature('researchCompanion')"
      ...
      <UCard class="max-w-lg">
        <div class="text-center">
          ...
          <p class="mt-2 text-gray-500">
            Get AI-powered research assistance with your project sources. Ask questions, verify
            facts, brainstorm ideas, and identify research gaps.
          </p>
    ...
    <div v-else class="h-full flex flex-col">
      <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 class="text-lg font-semibold text-gray-900 dark:text-white">Research Companion</h1>
